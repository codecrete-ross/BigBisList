...
function AceConfigDialog:AddToBlizOptions(appName, name, parent, ...)
	...
	if not BlizOptions[appName][key] then
		...
		if Settings and Settings.RegisterCanvasLayoutCategory then
			...
			if parent then
				category, layout = Settings.RegisterCanvasLayoutSubcategory(BlizOptions[appName][parent].frame.category, group.frame, name or appName, name or appName)
			else
				category, layout = Settings.RegisterCanvasLayoutCategory(group.frame, name or appName, name or appName)
			end
